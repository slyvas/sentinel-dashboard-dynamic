# Sentinel 控制台（1.6.0使用zookeeper实现动态规则扩展，目前只支持流控规则和降级规则）
...
-Dcsp.sentinel.zookeeper=localhost:2181 \
...
|`-Dcsp.sentinel.zookeeper=localhost:2181`|向Sentinel指定zookeeper地址|
